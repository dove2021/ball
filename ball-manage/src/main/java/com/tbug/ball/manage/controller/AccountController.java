...
public class AccountController extends BaseController {
	...
	PageDto<BrokerAccountExDto> brokerList(@RequestParam Map<String, Object> params){
		Query query = new Query(params);
		if (null != query.get("signCode")){
			BrokerDto dto = brokerService.getBrokerDtoBySignCode((String) query.get("signCode"));
			query.remove("signCode");
			query.put("levelCode", dto == null ? null : dto.getLevelCode());
		}
