...
<style type="text/css">
.c_default {background-color: #0772B6;color: white;width: 60px;}
</style>
		...
		<div class="page__bd">
	        ...
	        <div class="weui-cells">
	        	<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<div id="stakeType" class="weui-btn weui-btn_mini weui-btn_default c_default" >&nbsp;${orderH.stakeType == '1' ? '胜' : orderH.stakeType == '2' ? '平' : orderH.stakeType == '3' ? '负' : orderH.stakeType}&nbsp;</div>
					</div>
				</div>
	        	<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">下注额度</label></div>
					<div class="weui-cell__bd">
						<div id="stakePrice" class="weui-btn weui-btn_mini weui-btn_default c_default" ><fmt:formatNumber value="${orderH.stakePrice}" pattern="##0"/></div>
					</div>
				</div>
	        	<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">下注手数</label></div>
					<div class="weui-cell__bd">
						<div id="orderNum" class="weui-btn weui-btn_mini weui-btn_default c_default" >${orderH.orderNum}</div>
					</div>
				</div>
	        	<div class="weui-cell">
	        	...
	        	<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<c:choose>
							...
							<div id="gameResult" class="weui-btn weui-btn_mini weui-btn_default c_default">&nbsp;${scheduleDto.gameResult == '1' ? '胜' : scheduleDto.gameResult == '2' ? '平' : scheduleDto.gameResult == '3' ? '负' : scheduleDto.gameResult}&nbsp;</div>
							</c:when>
							<c:otherwise>
							<div id="gameResult" class="weui-btn weui-btn_mini weui-btn_default" style="background-color: #1aad19;color: white;">&nbsp;${scheduleDto.gameResult == '1' ? '胜' : scheduleDto.gameResult == '2' ? '平' : scheduleDto.gameResult == '3' ? '负' : scheduleDto.gameResult}&nbsp;</div>
							</c:otherwise>
						</c:choose>
					</div>
				</div>
