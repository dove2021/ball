...
public class CodeFactory {
	...
	/** 提现订单编号 */
	public static final String WITHDRAE_NO = "WITHDRAE_NO";
	/** 代理商编号 */
	public static final String BROKER_CODE = "BROKER_CODE";
	/** 后台管理员编号 */
	public static final String SYS_USER_USER_CODE = "SYS_USER_USER_CODE";
	/** 客户编号 */
	...
	/**
	 * 生成支付订单编号
	 * 规则: ZF 2位  + yyyyMMdd 8位 + 顺序增长序列 8位
	 * @return
	 * @throws BizException 
	 */
	public String getOrderCode() throws BizException{
		...
		value = formatSequence(value, 8);
		
		return "ZF" + DateStr + value;
	}
	...
	/**
	 * 生成提现渠道订单编号
	 * 规则: TX 2位 + yyyyMMddHHmm 12位 + 顺序增长序列流水 6位 
	 * @return
	 * @throws BizException
	 */
	public String getWithdrawNo() throws BizException{
		
		String DateStr = DateUtil.formatDate(new Date(), "yyyyMMddHHmm");
		
		String value = "" + sequenceBiz.getNextVal(WITHDRAE_NO);
		
		value = formatSequence(value, 6);
		
		return "TX" + DateStr + value;
	}
	 ...
	 * @throws BizException 
	 */
	public String getSysUserUserCode() throws BizException{
		
		String dateStr = DateUtil.formatDate(new Date(), "yyMMdd");
		
		String value = "" + sequenceBiz.getNextVal(SYS_USER_USER_CODE);
